...
/* **** MOD. ***** */
    ...
    for(uint8_t i=0;i<cnt;++i){
        ...
        ESP_LOGI(TAG, "segment %d : paddr=%08x vaddr=%08x size=%08x", i, data_addr, load_addr, len);
    }

    ESP_LOGI(TAG,"_iram_text_start: 0x%08x",(int)(&_iram_text_start));
    ESP_LOGI(TAG,"_iram_text_end: 0x%08x",(int)(&_iram_text_end));
